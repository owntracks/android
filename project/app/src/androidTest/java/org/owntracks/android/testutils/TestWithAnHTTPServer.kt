...
interface TestWithAnHTTPServer {
    /**
     * Configures the app on the device to use the local HTTP server, setting the mode and URL correctly
     */
     ...
     * URL. The responses map parameter specifies a map of paths and responses to be generated (with
     * a 200 status code) when GET requests are made to that path. All other requests will receive a
     * 404 response
     */
