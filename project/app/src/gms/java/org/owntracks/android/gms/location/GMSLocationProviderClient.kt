...
/**
 * An implementation of [LocationProviderClient] that uses a [FusedLocationProviderClient] to
 * request location updates
 *
 * @property fusedLocationProviderClient instance of Google location client to use to request
 *   updates
 */
class GMSLocationProviderClient(
   ...
   * @param clientCallBack a [LocationCallback] instance that's invoked on new locations / location
   *   availability
  ...
  override fun actuallyRequestLocationUpdates(
    ...
    fusedLocationProviderClient
        .requestLocationUpdates(gmsLocationRequest, gmsCallBack, looper)
