 ...
 *
 * @property preferences instance of [Preferences] that we're going to read/write values to and from.
 */
@Singleton
class PreferenceDataStoreShim @Inject constructor(private val preferences: Preferences) : PreferenceDataStore() {
    ...
    override fun getString(key: String?, defValue: String?): String? {
        return (key?.run(preferences::getPreferenceByName) ?: defValue) as String
    }
    ...
    override fun putString(key: String?, value: String?) {
        key?.let { notNullKey ->
            value?.let { notNullValue ->
                preferences.importKeyValue(notNullKey, notNullValue)
            }
        }
    }
