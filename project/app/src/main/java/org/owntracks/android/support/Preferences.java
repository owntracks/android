...
public class Preferences {
    ...
    public boolean isModeMqttPrivate() {
        return modeId == App.MODE_ID_MQTT_PRIVATE;
    }

    public boolean isModeMqttPublic() {
        return modeId == App.MODE_ID_MQTT_PUBLIC;
    }

    public boolean isModeHttpPrivate() {
        return modeId == App.MODE_ID_HTTP_PRIVATE;
    }
    ...
    @Import(key = Keys.GEOCODING_PROVIDER_TYPE)
    public void setGeocodingProviderType(GeocodingProviderType geocodingProviderType) {
        setString(Keys.GEOCODING_PROVIDER_TYPE, geocodingProviderType.name());
    }

    @Export(key = Keys.GEOCODING_PROVIDER_TYPE, exportModeMqttPrivate = true, exportModeHttpPrivate = true, exportModeMqttPublic = true)
    public GeocodingProviderType getGeocodingProviderType() {
        try {
            return GeocodingProviderType.valueOf(getString(Keys.GEOCODING_PROVIDER_TYPE, R.string.valEmpty));
    ...
    public static class Keys {
        ...
        public static final String GEOCODING_PROVIDER_TYPE = "geocodingProviderType";
