...
class Preferences @Inject constructor(@AppContext c: Context, private val eventBus: EventBus?, private val preferencesStore: PreferencesStore) {
    ...
    companion object {
        ...
        const val REVERSE_GEOCODE_PROVIDER_NOMINATIM = "Nominatim"
        val REVERSE_GEOCODE_PROVIDERS = listOf(REVERSE_GEOCODE_PROVIDER_NONE, REVERSE_GEOCODE_PROVIDER_GOOGLE, REVERSE_GEOCODE_PROVIDER_OPENCAGE, REVERSE_GEOCODE_PROVIDER_NOMINATIM)
    }
}