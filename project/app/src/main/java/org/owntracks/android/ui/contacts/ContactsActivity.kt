...
class ContactsActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = DataBindingUtil.setContentView<UiContactsBinding>(this, R.layout.ui_contacts)
            .apply {
                vm = viewModel
                appbar.toolbar.run {
        ...
        lifecycleScope.launch {
            viewModel.contactUpdatedEvent.collect {
                ...
                binding.run {
                    ...
                    contactsRecyclerView.visibility = if (viewModel.contacts.isEmpty()) View.GONE else View.VISIBLE
                }
