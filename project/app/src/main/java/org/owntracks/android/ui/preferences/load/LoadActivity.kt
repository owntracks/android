...
class LoadActivity : AppCompatActivity() {
    ...
    override fun onPrepareOptionsMenu(menu: Menu): Boolean {
        menu.findItem(R.id.close).isVisible = viewModel.configurationImportStatus.value !== ImportStatus.LOADING
        menu.findItem(R.id.save).isVisible = viewModel.configurationImportStatus.value === ImportStatus.SUCCESS
        return true
    }
    ...
    private fun handleIntent(intent: Intent?) {
        ...
        setHasBack(
            intent.getBundleExtra("_args")
                ?.getBoolean(FLAG_IN_APP, false) ?: false
        )
    ...
    private val filePickerResultLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
