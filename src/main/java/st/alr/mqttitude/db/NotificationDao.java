...
public class NotificationDao extends AbstractDao<Notification, Long> {
	...
	public static class Properties {
		public final static Property Id = new Property(0, Long.class, "id",
				true, "_id");
		public final static Property Topic = new Property(1, String.class,
				"topic", false, "TOPIC");
		public final static Property NotificationTitle = new Property(2,
		...
		public final static Property TransitionType = new Property(4,
	...
	public void readEntity(Cursor cursor, Notification entity, int offset) {
		entity.setId(cursor.isNull(offset + 0) ? null : cursor
				.getLong(offset + 0));
		entity.setTopic(cursor.isNull(offset + 1) ? null : cursor
				.getString(offset + 1));
		entity.setNotificationTitle(cursor.isNull(offset + 2) ? null : cursor
				.getString(offset + 2));
		entity.setDescription(cursor.isNull(offset + 3) ? null : cursor
				.getString(offset + 3));
		entity.setTransitionType(cursor.isNull(offset + 4) ? null : cursor
				.getInt(offset + 4));
	}
