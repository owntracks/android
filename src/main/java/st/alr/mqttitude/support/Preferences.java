...
public class Preferences {
	...
	public static boolean getBoolean(int resId, int defId) {
		return getSharedPreferences().getBoolean(getKey(resId),
				App.getContext().getResources().getBoolean(defId));
	}

	public static int getInt(int resId, int defId) {
		return getSharedPreferences().getInt(getKey(resId),
				App.getContext().getResources().getInteger(defId));
	}

	public static String getString(int resId, int defId) {
		String s = getSharedPreferences().getString(getKey(resId),
				App.getContext().getResources().getString(defId));
		if ((s == null) || s.equals(""))
	...
	public static boolean isAdvancedModeEnabled() {
		return getBoolean(R.string.keyAdvancedConnectionPreferencesEnabled,
				R.bool.valAdvancedConnectionPreferencesEnabled);
	}
	...
	public static boolean isContactLinkCloudStorageEnabled() {
		return getBoolean(R.string.keyContactsLinkCloudStorageEnabled,
				R.bool.valContactsLinkCloudStorageEnabled);
	}
	...
	public static int getLocatorBackgroundDisplacement() {
		return Integer.parseInt(getString(
				R.string.keyLocatorBackgroundDisplacement,
				R.string.valLocatorBackgroundDisplacement));
	}

	public static long getLocatorBackgroundInterval() {
		return TimeUnit.MINUTES.toMillis(Long.parseLong(getString(
				R.string.keyLocatorBackgroundInterval,
				R.string.valLocatorBackgroundInterval)));
	}
	...
	public static int getBrokerAuthType() {
		return getInt(R.string.keyBrokerAuth,
				R.integer.valBrokerAuthTypeUsernamePw);
	...
	public static int getBrokerSecurityType() {
		return getInt(R.string.keyBrokerSecurity,
				R.integer.valBrokerSecurityTypeTls);
	}
	...
	public static boolean isNotificationEnabled() {
		return getBoolean(R.string.keyNotificationEnabled,
				R.bool.valNotificationEnabled);
	}

	public static boolean notificationOnGeofenceTransition() {
		return getBoolean(R.string.keyNotificationTickerGeofence,
				R.bool.valNotificationTickerGeofence);
	}

	public static boolean notificationTickerOnPublish() {
		return getBoolean(R.string.keyNotificationTickerPublish,
				R.bool.valNotificationTickerPublish);
	}

	public static boolean isNotificationGeocoderEnabled() {
		return getBoolean(R.string.keyNotificationGeocoderEnabled,
				R.bool.valNotificationGeocoderEnabled);
	}

	public static boolean isNotificationLocationEnabled() {
		return getBoolean(R.string.keyNotificationLocationEnabled,
				R.bool.valNotificationLocationEnabled);
	}

	public static int getPubQos() {
		try {
			return Integer.parseInt(getString(R.string.keyPubQos,
					R.string.valPubQos));
		} catch (Exception e) {
			return 0;
		}
	...
	public static int getPubAutoInterval() {
		int ui;
		try {
			ui = Integer.parseInt(getString(R.string.keyPubAutoInterval,
					R.string.valPubAutoInterval));
		} catch (Exception e) {
			ui = 30;
		}
	...
	public static boolean isAutostartOnBootEnabled() {
		return getBoolean(R.string.keyAutostartOnBootEnabled,
				R.bool.valAutostartOnBootEnabled);
	}
	...
	public static int getLocatorForegroundAccuracy() {
		return getLocatorAccuracy(Integer.parseInt(getString(
				R.string.keyLocatorAccuracyForeground,
				R.string.valLocatorAccuracyForeground)));
	}

	public static int getLocatorBackgroundAccuracy() {
		return getLocatorAccuracy(Integer.parseInt(getString(
				R.string.keyLocatorAccuracyBackground,
				R.string.valLocatorAccuracyBackground)));
