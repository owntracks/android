...
public class WaypointDao extends AbstractDao<Waypoint, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Radius = new Property(4, Float.class, "radius", false, "RADIUS");
    ...
    public void readEntity(Cursor cursor, Waypoint entity, int offset) {
        ...
        entity.setRadius(cursor.isNull(offset + 4) ? null : cursor.getFloat(offset + 4));
